              ...
              <div className="space-y-4 max-w-lg">
                {goalOptions.map((option) => (
                  <button
                    ...
                    className={`onboading-option-btn ${formData.goal === option.value && "ring-2 ring-emerald-500"}`}
                  >
              ...
              <div className="space-y-8 max-w-lg">
                ...
                <div className="space-y-6">
                  <Slider
                    ...
                    unit="kcal"
                    infoText="Thetotal calories you plan to consume each day."
                  />
                  <Slider
                    label="Daily calorie Vurn"
                    min={100}
                    max={2000}
                    step={50}
